...
Popup {
    ...
    LabelSubheading {
        ...
        text: nfcManager.settingsFavoriteAddress
    ...
    TextFieldInt {
        ...
        text: nfcManager.settingsBatteryLevelInfo
    }
    TextFieldInt {
        id: t2
        width: (parent.width - 120)/2
        ...
        text: nfcManager.settingsBatteryLevelWarning
    }
    ...
    ButtonFlat {
        ...
        onClicked: {
            ...
            if(infoValue !== nfcManager.settingsBatteryLevelInfo || warningValue !== nfcManager.settingsBatteryLevelWarning) {
                nfcManager.setBatteryValues(infoValue, warningValue)
            }
            thePopup.close()
        }
    }
