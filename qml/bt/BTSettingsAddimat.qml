...
Popup {
    ...
    TextFieldInt {
        ...
        text: lockManager.settingsBatteryLevelInfo
    }
    TextFieldInt {
        id: t2
        width: (parent.width - 120)/2
        ...
        text: lockManager.settingsBatteryLevelWarning
    }
    ...
    ButtonFlat {
        ...
        onClicked: {
            ...
            if(infoValue !== lockManager.settingsBatteryLevelInfo || warningValue !== lockManager.settingsBatteryLevelWarning) {
                lockManager.setBatteryValues(infoValue, warningValue)
            }
            thePopup.close()
        }
    }
